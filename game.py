...
class SnakeGameRL:
    ...
    def _reset(self):
        ...
        self.food = None
        self._place_food()
        self.iterator = 0 # Frame iterator
    ...
    def play_step(self, action):
        ...
        reward = 0
        game_over = False
        if self._is_collision() or self.iterator > self.max_time_factor*len(self.snake):
            game_over = True
            reward = -10
    ...
    def _close_collision(self,pt:Point):
        # hits boundary
    ...
    def _move(self, action):
        """Determines movement wrt action und updates head of snake
